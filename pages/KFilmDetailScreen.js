...
function KFilmDetailScreen({ route }) {
    ...
    fetch(`https://api.themoviedb.org/3/movie/${item.id}?api_key=${apiKey}&language=en-US`)
      ...
      .then(json => {
        setData([
          ...
          { key: 'title', value: json.original_title },
          { key: 'title', value: json.tagline },
          { title: 'Rating', value: `${json.vote_average}/10` },
          { title: 'Air Date', value: json.first_air_date || json.release_date },
          { title: 'Runtime', value: `${json.runtime} minutes` },
...
export default KFilmDetailScreen;
